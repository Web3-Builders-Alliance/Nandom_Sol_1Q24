export type Week1 = {
	...
	instructions: [
		{
			...
			accounts: [
				{ name: 'owner'; isMut: true; isSigner: true },
				{
					...
					pda: {
						seeds: [
							{ kind: 'const'; type: 'string'; value: 'profile' },
		...
		},
		{
			...
			accounts: [
				{ name: 'owner'; isMut: true; isSigner: true },
				{ name: 'ata'; isMut: true; isSigner: false },
				{
					name: 'profile'
					isMut: true
					isSigner: false
				...
				},
				{
					...
					pda: {
						seeds: [
							{ kind: 'const'; type: 'string'; value: 'vault1' },
							{ kind: 'account'; type: 'publicKey'; path: 'owner' },
							{
								kind: 'account'
								type: 'publicKey'
		...
		},
		{
			...
			accounts: [
				...
				},
				{
					...
					pda: {
						seeds: [
							{ kind: 'const'; type: 'string'; value: 'vault2' },
							{ kind: 'account'; type: 'publicKey'; path: 'owner' },
							{
								kind: 'account'
								type: 'publicKey'
		...
		},
		{
			...
			accounts: [
				...
				},
				{
					...
					isMut: true
					isSigner: false
					docs: ['CHECK idgaf if we get exploited']
					pda: { seeds: [{ kind: 'const'; type: 'string'; value: 'auth' }] }
				},
		...
		},
		{
			...
			accounts: [
				...
				},
				{
					...
					pda: {
						seeds: [
							{ kind: 'const'; type: 'string'; value: 'vault4' },
							{ kind: 'account'; type: 'publicKey'; path: 'owner' },
							{
								kind: 'account'
								type: 'publicKey'
				...
				},
				{
					...
					pda: {
						seeds: [
							...
							{ kind: 'account'; type: 'publicKey'; path: 'metadata_program' },
							{
								kind: 'account'
								type: 'publicKey'
								account: 'Mint'
	...
	errors: [
		{ code: 6000; name: 'BumpError'; msg: 'Invalid bump' },
		{
			code: 6001
